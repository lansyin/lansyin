...
Eventually, I decided to learn the ropes of VS Code extension development, and I managed to turn the tool into a proper [extension][ext]. It works smoothly and avoids the side effects that came with the standalone version.
